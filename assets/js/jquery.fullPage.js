...
(function(global, factory) {
    ...
    // Default options for iScroll.ts used when using scrollOverflow
    var iscrollOptions = {
        scrollbars: true,
        mouseWheel: true,
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        /**
        * Turns fullPage.ts to normal scrolling mode when the viewport `width` or `height`
        ...
        */
        ...
        /*
        * Destroys fullpage.ts plugin events and optinally its html markup and styles
        */
        ...
        /*
        * Removes inline styles added by fullpage.ts
        */
        ...
        */
        function displayWarnings(){
            ...
            if($('html').hasClass(ENABLED)){
                showError('error', 'Fullpage.ts can only be initialized once and you are doing it multiple times!');
                return;
            }
            ...
            extensions.forEach(function(extension){
                ...
                if(options[extension]){
                    showError('warn', 'fullpage.ts extensions require jquery.fullpage.extensions.min.ts file instead of the usual jquery.fullpage.ts. Requested: '+ extension);
                }
            });
     ...
     * to the fullpage.ts option that implements the same functions
     * as this handler.
     *
     * @type {Object}
     */
